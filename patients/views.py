...
def patient_confirm_book(request, doctor):
    try:
        doctor_instance = Doctors.objects.get(user__username=doctor)
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'patients/patient_confirm_book.html', {'error': 'Time slot not available', 'doctor': doctor_instance})
    ...
    return render(request, 'patients/patient_confirm_book.html', {'times': times, 'doctor': doctor_instance})
